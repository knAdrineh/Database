...
int main()
{
    ...
    do
    {
        ...
        case 2:
                ...
                age = data.searchRecord(name);
                if(age==0){
                    cout << "No such name in the directory to be replaced. " <<endl;
                }
                else{
                    cout << "Enter new name : " ;
                    getline(cin,current_name);
                    ...
                    cin >> current_age;
                    cout << "Replacing  ";
                    data.replaceItem(data.getRecordNum(name, age)-1, current_name, current_age);
                }
            break;
        case 3:
            data.printData();
